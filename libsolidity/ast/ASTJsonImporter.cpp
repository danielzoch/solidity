...
SourceLocation ASTJsonImporter::createNameSourceLocation(Json::Value const& _node)
{
	...
	string const nameLocationValue = _node["nameLocation"].asString();
	if (nameLocationValue.empty())
		return SourceLocation{};

	return solidity::langutil::parseSourceLocation(nameLocationValue, m_currentSourceName, m_sourceLocations.size());
}
